...
addOutStockDialog::addOutStockDialog(QWidget *parent)
    : QDialog(parent)
{
    setWindowTitle(tr("出库"));
    ...
    layout->addWidget(outButton,4,1);

    setLayout(layout);
    setWindowModality(Qt::WindowModal);
}

addOutStockDialog::~addOutStockDialog()
{
